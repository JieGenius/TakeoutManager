...
import com.example.genius.take_outmanager.AllShopBlack;
...
public class ShopBlackAdapter extends RecyclerView.Adapter<ShopBlackAdapter.ViewHolder>{
    private static final String TAG = "ShopBlackAdapter";
    public static List<AllShopBlack.ShopBlackArrBean> list;

    public ShopBlackAdapter(List<AllShopBlack.ShopBlackArrBean> list) {
        this.list = list;
    }
    @NonNull
    @Override
    public ShopBlackAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            ...
            switch (v.getId()) {
                case R.id.common_black_name:
                    ...
                    inputDialog.setPositiveButton("确定修改", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            String sql = "update 商家黑名单 set CB_name = '"+temp+"'where CB_num = "+list.get(getLayoutPosition()).getId();
                ...
                case R.id.common_black_phone:
                    ...
                    inputDialog.setPositiveButton("确定修改", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            String temp = editText.getText().toString();
                            String sql = "update 商家黑名单 set CB_phonenum = '"+temp+"'where CB_num = "+list.get(getLayoutPosition()).getId();
                ...
                case R.id.common_black_bt_remove:
                    String sql = "delete from 商家黑名单 where CB_num = "+list.get(getLayoutPosition()).getId()+";";
                    update(sql,v.getContext());
