...
public class DeliveryBlackAdapter extends RecyclerView.Adapter<DeliveryBlackAdapter.ViewHolder> {
    private static final String TAG = "DeliveryBlackAdapter";
    public static List<AllDeliveryBlack.DeliveryBlackArrBean> list;

    public DeliveryBlackAdapter(List<AllDeliveryBlack.DeliveryBlackArrBean> list) {
        this.list = list;
    }
    @NonNull
    @Override
            ...
            switch (v.getId()) {
                case R.id.common_black_name:
                    ...
                    inputDialog.setPositiveButton("确定修改", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            String sql = "update 骑手黑名单 set DB_name = '"+temp+"'where DB_num = "+list.get(getLayoutPosition()).getId();
                ...
                case R.id.common_black_phone:
                    ...
                    inputDialog.setPositiveButton("确定修改", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            String temp = editText.getText().toString();
                            String sql = "update 骑手黑名单 set DB_phonenum = '"+temp+"'where DB_num = "+list.get(getLayoutPosition()).getId();
                ...
                case R.id.common_black_bt_remove:
                    String sql = "delete from 骑手黑名单 where DB_num = "+list.get(getLayoutPosition()).getId()+";";
                    update(sql,v.getContext());
