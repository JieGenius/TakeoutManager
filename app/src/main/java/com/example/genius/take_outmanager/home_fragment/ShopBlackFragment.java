...
public class ShopBlackFragment extends Fragment {
    List<AllShopBlack.ShopBlackArrBean> list = new ArrayList<>();
    RecyclerView recyclerView ;
    public ShopBlackAdapter shopBlackAdapter;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        shopBlackAdapter = new ShopBlackAdapter(list);
        LinearLayoutManager layoutManager = new LinearLayoutManager(container.getContext());
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setAdapter(shopBlackAdapter);
    ...
    public void addData(List<AllShopBlack.ShopBlackArrBean> lists){
        this.list.clear();
        this.list.addAll(lists);
        if(shopBlackAdapter!=null){
            shopBlackAdapter.notifyDataSetChanged();
        }
    }
}
