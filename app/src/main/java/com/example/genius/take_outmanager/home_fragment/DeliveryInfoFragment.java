...
public class DeliveryInfoFragment extends Fragment {
    private static final String TAG = "DeliveryInfoFragment";
    List<AllDeliveyBean.DeliveryArrBean> list = new ArrayList<>();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        deliveryInfoAdapter = new DeliveryInfoAdapter(list);
    ...
    public void addData(List<AllDeliveyBean.DeliveryArrBean> lists){
        this.list.clear();
